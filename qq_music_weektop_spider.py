...
if __name__ == '__main__':
    ...
    for urls in detail_url:
        ...
        if top_id:
            # print(top_id)
            if int(top_id[0]) not in [4,27,108,123,106,107,105,113,114,103]:
                get_top_msg(top_id[0])


# 'data: {"comm":{"ct":24,"cv":0},"songinfo":{"method":"get_song_detail_yqq","param":{"song_type":0,"song_mid":"000NgBjP4PclJ1","song_id":230437514},"module":"music.pf_song_detail_svr"}}'

#CREATE DATABASE `qq_music` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
# create table qq_music_top (top_title varchar(50),top_time varchar(100),song_top varchar(20),song_name varchar(200),song_id varchar(100),singer_name varchar(200),singer_mid varchar(200),create_time varchar(100));
# create table qq_music_detail (top_title varchar(50),top_time varchar(100),song_name varchar(200),song_id varchar(50),song_mid varchar(100),song_long_time varchar(50),song_time_public varchar(200),company_name varchar(120),company_id varchar(30),genre_name varchar(50),language varchar(20),album_name varchar(100),album_id varchar(30),singer_str varchar(200),create_time varchar(100));
# alter table qq_music_detail rename column singer to singer_str
# {"comm":{"ct":24,"cv":0},"songinfo":{"method":"get_song_detail_yqq","param":{"song_type":0,"song_mid":"000hdbrF4bBN6r","song_id":6574807},"module":"music.pf_song_detail_svr"}}